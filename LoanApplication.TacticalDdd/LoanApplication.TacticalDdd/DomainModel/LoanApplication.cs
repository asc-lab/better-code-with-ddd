...
public class LoanApplication : Entity
{
    ...
    public LoanApplication(string number, Customer customer, Property property, Loan loan, Operator registeredBy)
        : this(number, LoanApplicationStatus.New, customer, property, loan, null,
            new Registration(SysTime.Now(), registeredBy), null)
    {
    }
    ...
    public void Accept(Operator decisionBy)
    {
        ...
        if (Score == null) throw new ApplicationException("Cannot accept application before scoring");
